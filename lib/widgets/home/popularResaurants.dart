...
import 'package:clicandeats/widgets/home/popularRestaurantCard.dart';
...
class PopularRestaurants extends StatelessWidget {
  ...
  PopularRestaurants(this.filter, {required this.uId,
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: StreamBuilder(
                stream: FirebaseResOp().getPopularRestaurants(filter),
                      ...
                      return Row(
                        children: [
                          ...snapshot.data!.docs.map((resto) {
                            ...
                            return resto['totalOrders'] >0 ? Padding(
                              padding:
